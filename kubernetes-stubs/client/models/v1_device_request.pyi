    ...
    def __init__(
        ...
        *,
        ...
        first_available: typing.Optional[
            list[kubernetes.client.V1DeviceSubRequest]
        ] = ...,
        name: str,
    ) -> None: ...
...
class V1DeviceRequestDict(typing.TypedDict, total=False):
    exactly: kubernetes.client.V1ExactDeviceRequestDict
    firstAvailable: list[kubernetes.client.V1DeviceSubRequestDict]
    name: str
