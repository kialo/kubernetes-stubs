...
class V1beta1MutatingAdmissionPolicyBinding:
    ...
    spec: kubernetes.client.V1beta1MutatingAdmissionPolicyBindingSpec
    ...
    def __init__(
        ...
        *,
        ...
        spec: typing.Optional[
            kubernetes.client.V1beta1MutatingAdmissionPolicyBindingSpec
        ] = ...,
    ) -> None: ...
...
class V1beta1MutatingAdmissionPolicyBindingDict(typing.TypedDict, total=False):
    ...
    spec: kubernetes.client.V1beta1MutatingAdmissionPolicyBindingSpecDict
