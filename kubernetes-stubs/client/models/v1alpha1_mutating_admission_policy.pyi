...
class V1alpha1MutatingAdmissionPolicy:
    ...
    spec: kubernetes.client.V1alpha1MutatingAdmissionPolicySpec
    ...
    def __init__(
        ...
        *,
        ...
        spec: typing.Optional[
            kubernetes.client.V1alpha1MutatingAdmissionPolicySpec
        ] = ...,
    ) -> None: ...
...
class V1alpha1MutatingAdmissionPolicyDict(typing.TypedDict, total=False):
    ...
    spec: kubernetes.client.V1alpha1MutatingAdmissionPolicySpecDict
