...
class ResourceV1alpha3Api:
    ...
    ) -> kubernetes.client.V1alpha3DeviceClassList: ...
    def create_device_class(
        self,
        body: kubernetes.client.V1alpha3DeviceClass,
        *,
        pretty: typing.Optional[str] = ...,
    ...
    def create_device_taint_rule(
        self,
        body: kubernetes.client.V1alpha3DeviceTaintRule,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
    ...
    def list_namespaced_resource_claim(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes.client.V1alpha3ResourceClaimList: ...
    ...
    def list_namespaced_resource_claim_template(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes.client.V1alpha3ResourceClaimTemplateList: ...
    ...
    def list_resource_slice(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes.client.V1alpha3ResourceSliceList: ...
    def create_resource_slice(
        self,
        body: kubernetes.client.V1alpha3ResourceSlice,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
