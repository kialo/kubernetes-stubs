...
class ResourceV1beta2Api:
    ...
    def create_device_class(
        self,
        body: kubernetes.client.V1beta2DeviceClass,
        *,
        pretty: typing.Optional[str] = ...,
    ...
    def create_namespaced_resource_claim(
        self,
        namespace: str,
        body: kubernetes.client.V1beta2ResourceClaim,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
    ...
    def create_namespaced_resource_claim_template(
        self,
        namespace: str,
        body: kubernetes.client.V1beta2ResourceClaimTemplate,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
    ...
    def create_resource_slice(
        self,
        body: kubernetes.client.V1beta2ResourceSlice,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
