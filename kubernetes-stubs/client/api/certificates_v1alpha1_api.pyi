...
class CertificatesV1alpha1Api:
    ...
    def list_namespaced_pod_certificate_request(
        ...
        *,
        ...
        timeout_seconds: typing.Optional[int] = ...,
        watch: typing.Optional[bool] = ...,
    ) -> kubernetes.client.V1alpha1PodCertificateRequestList: ...
    def create_namespaced_pod_certificate_request(
        self,
        namespace: str,
        body: kubernetes.client.V1alpha1PodCertificateRequest,
        *,
        pretty: typing.Optional[str] = ...,
        dry_run: typing.Optional[str] = ...,
        field_manager: typing.Optional[str] = ...,
        field_validation: typing.Optional[str] = ...,
    ) -> kubernetes.client.V1alpha1PodCertificateRequest: ...
